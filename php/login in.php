...
<form action="login.php" class="col black-text" method="post" enctype="multipart/form-data">
  ...
  <div class="col">
    <input type="text" name="login" required="Заполните это поле!" placeholder="Введите логин">
  </div>
  ...
  <div class="col">
    <input type="password" name="password" required="Заполните это поле!" placeholder="Введите пароль">
  </div>
...
<button class="button1" type="submit">Вход</button>
    ...
    <p>
         У вас ещё нет аккаунта? <a href="../php/registr.php">Зарегистрироваться</a>
     </p>
     <br>
     <br>
